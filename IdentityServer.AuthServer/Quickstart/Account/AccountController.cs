...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            IEventService events, ICustomUserRepository userRepository, TestUserStore users = null)
        {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (await _userRepository.Validate(model.Email,model.Password))
                {
                    var user = await _userRepository.FindUserByEmail(model.Email);
                    await _events.RaiseAsync(new UserLoginSuccessEvent(model.Email, user.Id.ToString(), user.UserName, clientId: context?.Client.ClientId));
